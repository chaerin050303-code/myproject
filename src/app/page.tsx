        ...
        <div className="flex items-center gap-4">
          {!user ? (
            ...
            <div className="flex items-center gap-3">
              <img src={user.photoURL} alt="profile" className="w-9 h-9 rounded-full border" />
          ...
          <a className="ml-2 inline-block bg-white px-4 py-2 rounded-full text-sm shadow hover:shadow-md" href="#">Contact</a>
        </div>
      </header>
        ...
        <div className="relative bg-white rounded-3xl overflow-hidden shadow-xl">
          ...
          <div className="absolute left-0 right-0 -top-36 pointer-events-none">
            <svg viewBox="0 0 1200 300" className="w-full h-72">
              ...
              <path d="M0,200 C200,120 400,40 600,80 C800,120 1000,200 1200,160 L1200,0 L0,0 Z" fill="url(#g1)" opacity="0.95" />
            </svg>
          </div>
          ...
          <div className="grid md:grid-cols-2 gap-8 items-center px-8 py-20 relative z-10">
            ...
            <div className="pt-16 md:pt-0">
              ...
              <p className="mt-4 text-gray-600 max-w-xl">
                Carbonex는 비즈니스와 사회가 자연과 조화를 이루며 지속 가능한 미래를 만들도록 돕습니다. AI 기반 탄소 감축 플랜으로 영향력있는 변화를 시작하세요.
              </p>

              <div className="mt-8 flex flex-wrap gap-4 items-center">
                <a href="#" className="bg-emerald-600 text-white px-5 py-3 rounded-full shadow hover:bg-emerald-700">Schedule a consultation</a>
                <a href="#" className="text-sm text-gray-700 hover:underline">Learn more</a>
              </div>
            ...
            <div className="flex items-center justify-center">
              <div className="w-full max-w-md">
                {/* Simple landscape SVG to emulate 이미지 분위기 */}
                <svg viewBox="0 0 600 420" className="w-full">
                  ...
                  <g transform="translate(0,60)">
                    <path d="M0 220 C100 140 200 120 300 160 C400 200 500 160 600 180 L600 260 L0 260 Z" fill="url(#g-hill)" />
                    <path d="M0 240 C140 180 220 200 360 220 C460 230 540 200 600 220 L600 300 L0 300 Z" fill="#10b981" opacity="0.85" />
                  </g>
          ...
          {/* Bottom white card area with small metrics or links */}
          <div className="border-t border-gray-100 px-8 py-6 bg-white">
            <div className="max-w-6xl mx-auto flex flex-col md:flex-row items-center justify-between gap-4">
              ...
              <div className="flex gap-3">
                <a className="text-sm text-emerald-700 font-semibold" href="#">Schedule</a>
                <a className="text-sm text-gray-500" href="#">Impact Projects</a>
              </div>
            </div>
          </div>
        </div>
